"""drinkable_21221 URL Configuration
...
admin.site.site_header = "Drinkable"
admin.site.site_title = "Drinkable Admin Portal"
admin.site.index_title = "Drinkable Admin"

# swagger
api_info = openapi.Info(
    title="Drinkable API",
    default_version="v1",
    description="API documentation for Drinkable App",
)
